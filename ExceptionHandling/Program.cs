namespace ExceptionHandling
{
    internal class Program
    {
        ...
        static void BasicExceptionHandling()
        {
            ...
            {
                Console.WriteLine("Invalid input. Please re-enter a valid number.");
            }
        }
        ...
        static void CheckNumber(int number)
        {
            if (number > 100)
            {
                throw new ArgumentOutOfRangeException("Number should not exceed 100.");
            }
        }
        ...
        static void CheckNumberWithLogging(int number)
        {
            if (number > 100)
            {
                Console.WriteLine($"Logging: Number '{number}' exceeds the limit.");
                throw new ArgumentOutOfRangeException("Number should not exceed 100.");
            }
        }
    }
